        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="/data-mesin/{{$datamesin->id}}" id="myForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="kode_jenis" class="form-label">Nomor</label>
                            <input type="text" name="kode_jenis" class="form-control @error('kode_jenis') is-invalid @enderror" id="kode_jenis" placeholder="Masukkan nama jenis baru.." maxlength="10" readonly value="{{ $datamesin->kode_jenis }}">
                            @error('nama_mesin')
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                <input type="text" name="nama_mesin" class="form-control" id="nama_mesin" value="{{$datamesin->nama_mesin}}">
                            </div>
                            <div class="col">
                                <label for="kapasitas" class="form-label">Kapasitas</label>
                                <input type="text" name="kapasitas" class="form-control" id="kapasitas" placeholder="Masukan Kapasitas Bulanan" value="{{$datamesin->kapasitas}}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                <select id="single-select-field" name="nama_kategori" class="form-control">
                                    ...
                                    <option value="{{ $data->id }}" data-id="{{ $data->id }}" data-kode-kategori="{{ $data->kode_kategori }}" {{ $datamesin->nama_kategori == $data->id ? 'selected' : '' }}>
                                        {{ $data->nama_kategori }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                <input type="text" name="type_mesin" class="form-control" id="type_mesin" value="{{$datamesin->type_mesin}}">
                            </div>
                            <div class="col">
                                <label for="merk_mesin" class="form-label">Merk</label>
                                <input type="text" name="merk_mesin" class="form-control" id="merk_mesin" value="{{$datamesin->merk_mesin}}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="spek_min" class="form-control" id="spek_min" placeholder="Masukan Minimal" value="{{$datamesin->spek_min}}">
                            </div>
                            <div class="col">
                                <label class="text-primary" for="spek_max">Max.</label>
                                <input type="text" name="spek_max" class="form-control" id="spek_max" placeholder="Masukan maximal" value="{{$datamesin->spek_max}}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                <input type="text" name="pabrik" class="form-control" id="pabrik" placeholder="Masukan Negara Pembuat" value="{{$datamesin->pabrik}}">
                            </div>
                            <div class="col">
                                <label for="tahun_mesin" class="form-label">Tahun Mesin</label>
                                <input type="text" name="tahun_mesin" class="form-control" id="tahun_mesin" value="{{$datamesin->tahun_mesin}}">
                            </div>
                        </div>
                        @error('tahun_mesin')
...
<script>
    ...
    $(document).ready(function() {
        ...
        function incrementNomorUrut(inputString, current) {
            ...
            if (current.id == x) {
                var nextNomorUrutInt = nomorUrutInt;
            } else {
